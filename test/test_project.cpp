...
TEST(MemTableTest, BasicPutGet) {
  auto mt = MemTable<uint32_t, uint32_t, NaiveSpinLock,
                     NaiveSkipList<uint32_t, uint32_t>>{};
  uint32_t value;
...
TEST(MemTableTest, ScalePutGetv2) {
  auto mt = MemTable<uint32_t, uint32_t, NaiveSpinLock,
                     NaiveSkipList<uint32_t, uint32_t>>{};
  constexpr int scale = 32768;
  constexpr int initial_insert = 8192;
...
TEST(MemTableTest, ScalePutGetv3) {
  auto mt =
      MemTable<uint32_t, uint32_t, NoLock, SkipList<uint32_t, uint32_t>>{};
  constexpr int scale = 32768;
  constexpr int initial_insert = 8192;
  constexpr int num_search_threads = 8;
  constexpr int num_insert_threads = 1;
...
TEST(MemTableTest, ScalePutGetv4) {
  auto mt =
      MemTable<uint32_t, uint32_t, NoLock, NaiveSkipList<uint32_t, uint32_t>>{};
  constexpr int scale = 32768;
  constexpr int initial_insert = 8192;
  constexpr int num_search_threads = 8;
  constexpr int num_insert_threads = 1;
